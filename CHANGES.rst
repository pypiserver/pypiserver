...
2.1.2rc09-15-2024 (__rc__)
--------------------------

- d68355a chore: cleanup README (#591)
- c21c1e8 feat: use json client for `update` (#588)
- 6c43e19 chore: solve deprecated `types-pkg_resources` (#589)
