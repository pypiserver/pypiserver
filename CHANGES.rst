...
- 6cc6b29 MAINT: chore: Bump soupsieve from 2.8.3 to 2.9 (#730)
- e5dde71 MAINT: chore: Bump pip from 26.1 to 26.2 (#729)
- e595e24 MAINT: chore: Bump webob from 1.8.10 to 1.8.11 (#727)
- a278633 MAINT: chore: Bump cryptography from 48.0.1 to 50.0.0 (#721)
- d87ef03 MAINT: chore: Bump cryptography from 46.0.7 to 48.0.1 (#712)
- 88dc4ed FIX: fix: harden /RPC2 XML parser against entity-expansion DoS [#685] (#704)
- beb6c51 MAINT: chore: Bump cryptography from 46.0.5 to 46.0.7 (#710)
- 5e74cb4 MAINT: chore: Bump webob from 1.8.9 to 1.8.10 (#706)
- 3f03eb3 MAINT: chore: Bump pygments from 2.19.2 to 2.20.0 (#707)
- 0285270 MAINT: chore: Bump requests from 2.32.5 to 2.33.0 (#708)
- 4a58684 MAINT: chore: Bump pytest from 9.0.2 to 9.0.3 (#709)
- 8f6f277 MAINT: docs: clarify Dockerfile CMD/ENTRYPOINT arg parsing for -P and friends (#699)
- e85d902 MAINT: chore: Bump pip from 26.0.1 to 26.1 (#702)
- b5ef664 MAINT: chore: Bump urllib3 from 2.6.3 to 2.7.0 (#701)
- 91ac3ff MAINT: chore: Bump idna from 3.11 to 3.15 (#700)
- e0db8f5 MAINT: feat: migrate from isort+black to ruff (#666)
- 92902b9 MAINT: chore: remove eclipse project configs (#697)
- 8236199 MAINT: maint: support `uv` for development and project configuration management  (#687)
- d79dfe3 MAINT: chore: Bump gunicorn from 20.0.4 to 22.0.0 in /docker (#696)
- 532b58b MAINT: ci: bump up checkout/python actions to v6 (#695)
- 9830e43 MAINT: refactor: add missing type hints for bin/bumpver.py (#665)
- 98511b5 MAINT: refactor: fix mypy complaints for `pypiserver/manage.py` (#693)
- 4c6959e MAINT: refactor: improve type hints of `pypiserver/__main__.py` (#692)

2.4.1 (2026-02-10)
--------------------------

- 9e5b9bb MAINT: Remove unused import LooseVersion from distutils.version (#681)
- 945e23e MAINT: chore: move mypy config from setup.cfg to pyproject.toml (#664)
...
- 53f134c MAINT: chore: Update setuptools requirement from <71.0.0,>=40.0 to >=40.0,<81.0.0 in /requirements (#671)
