...
class TestPermissions:
    ...
    # Generaly for these tests, we're going to run the container as the current
    # user's UID. This is the default behavior on Mac, but is not on Linux,
    # since the docker daemon is generally run as root (unless you're running
    # rootless).
